    ...
    return (<div className="h-full flex flex-col gap-6">
      ...
      <div className="flex-1 overflow-y-auto pr-4 custom-scrollbar relative">
        ...
        <div className="absolute left-4 md:left-[15%] top-0 bottom-0 w-px bg-primary/20">
          ...
          <motion.div className="absolute top-0 left-[-1px] w-[3px] h-32 bg-primary shadow-[0_0_15px_#00f3ff]" animate={{ top: ["0%", "100%"] }} transition={{ duration: 5, repeat: Infinity, ease: "linear" }}/>
        </div>
